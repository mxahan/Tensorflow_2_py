...
class Discriminator(Model):
    def __init__(self, classnumber):
        ...
        self.conv2 = ConvBnRelu(ch = 128, kernel_size = 3 , strides = 2) # 64,64,32
        self.conv3 = ConvBnRelu(ch = 256, kernel_size = 3 , strides = 2) # 32,32,16
        self.conv4 = ConvBnRelu(ch = 128, kernel_size = 3 , strides = 2) # 32,32,16
        self.conv5 = ConvBnRelu(ch = 64, kernel_size = 5 , strides = 2) # 16,16,16
...
class weakDiscriminator(Model):
    def __init__(self, classnumber):
        ...
        self.conv2 = ConvBnRelu(ch = 16, kernel_size = 5 , strides = 2) # 64,64,16
